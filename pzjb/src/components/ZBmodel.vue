<template>
  <div>
    <Row style='margin-top:30px'>
      <Col span="22" offset="1" style="font-size:24px;height:40px;line-height:40px;" >众包模版申请</Col>
      ...
      <div style="padding: 0px">
        <Tabs :value='value'>
                 ...
                 <Col span="13" offset="1"><Card :bordered="false" dis-hover>
                    <Form :model="formItem" label-position="left" :label-width="120">
                        ...
                        <FormItem label="期望时效性" required >
                            <Select v-model="formItem.select2" transfer>
                                <Option value="T+1">T+1</Option>
                                <Option value="一小时">一小时</Option>
                                <Option value="10分钟">10分钟</Option>
                            </Select>
                        </FormItem>
                        <Checkbox v-model="formItem.single">需要脱敏处理</Checkbox>
                        <Poptip trigger="hover" content="图片切割后再派发图片，避免泄露敏感信息" placement="right" transfer >
                            <Icon type="information-circled" size="14"></Icon>
                        </Poptip>
                        </Col>
                        <!-- <Col span="24"> -->
            ...
            <TabPane label=""  disabled name='name3'>
                <div v-if="current == 3">
                 <Card :bordered="false" dis-hover>
                     <Col style="margin-bottom:50px;font-size:24px;color:#323232;" span="22" offset="1">众包模版信息</Col>
                     <Row>
  ...
  methods: {
      ...
      submit(){
        ...
        var json_params = {
            ...
            mark_overlaid : false,
            expected_time : this.formItem.select2,
            desensitization : this.formItem.single
        };
        ...
        // this.$router.push({path:'/zhongbaoSubmit'});
      },
      upload(){
        let self=this  
