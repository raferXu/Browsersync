<template>
  <div id="zbmodel">
    ...
    <Row style='padding:1px 1px;background:#f5f5f5;'>
                    ...
                    <Row style='margin-bottom:20px'>
                        ...
                        <Col span='8' style="padding-left:10px;" >
                            <Card :bordered="false" id="canvas_box" style='height:300px'  dis-hover>
                                <!-- <Col span='24' offset="">
                                <input multiple type="file" ref='upload' @change="upload" style='display:none'>
                                <div style='margin-bottom:5px;padding: 20px 0;width:100%;text-align:center;cursor:pointer;' @click='uploadfile'>
                    ...
                    <Form :model="formItem" label-position="left" :label-width="120">
                        ...
                        <FormItem label="预计调用峰值" required>
                            <Input v-model="formItem.input5">
                                <span slot="append">字段/小时</span>
                            </Input>
                        </FormItem>
                        </Col></Col>
                        <Col span="13" class="select_need">
                        <FormItem label="需要脱敏处理" required>
                            <Poptip  slot="label" trigger="hover" content="图片切割后再派发图片，避免泄漏敏感信息。" transfer  placement="bottom">
                                需要脱敏处理 <Icon type="information-circled" />
                            </Poptip>
...
<script>
import Pic from '@/components/manageCanvas.vue'
export default {
  components:{
      Pic
  },
  ...
  methods: {
    ...
    //   })
        ...
        this.axios.all([
            ...
            _this.axios({
                ...
                console.log(12345)
                console.log(res);
                _this.$router.push({path:'/zhongbaoSubmit'});
    ...
    deleteMes(msg){
        if(this.saveFiles[msg.n].infoList && this.saveFiles[msg.n].infoList[msg.m].value){
            this.saveFiles[msg.n].infoList[msg.m].value = "已删除";
        }else{
            this.saveImg[msg.m].value="已删除";
            this.saveImg[msg.m].value1="已删除";
        }
        // this.saveFiles[msg.n].infoList[msg.m].value = "已删除";
...
#zbmodel .ivu-tabs .ivu-tabs-bar {
        display: none;
    }
#zbmodel .ivu-steps-horizontal .ivu-steps-content{
        padding-left: 0px;
    margin-left: -15px;
    margin-top: 10px;
}
...
#zbmodel .ivu-steps-content{
    font-size:18px;
}
#zbmodel .ivu-steps-item.ivu-steps-status-process .ivu-steps-head-inner{
    border-color: #78c4ff;
    background-color: #78c4ff;
}
#zbmodel .ivu-form-item{
    margin-bottom: 20px;
}
/* .btn1{width:130px;height:54px;font-size:20px;margin-right:40px;} */
#zbmodel .ivu-upload-drag{
    border:none;
    
    padding-bottom: 20px;
}
#zbmodel .ivu-upload-drag:hover{
    border:none;
}
#uploadm .ivu-upload-drag{
    background:#fff;
}
#zbmodel .ivu-form-item-label{
    height:100%;
    line-height:100%;
}
#zbmodel .ivu-radio-group-button .ivu-radio-wrapper{
...
#zbmodel .ivu-radio-group-button .ivu-radio-wrapper-checked{
    background:#2d8cf0;
    color:#fff;
}
#zbmodel .select_time .ivu-radio-group-button .ivu-radio-wrapper{
    margin-right:0px;
    width:100px;
}
#zbmodel .select_need .ivu-radio-group-button .ivu-radio-wrapper{
     width:100px;
}
#zbmodel .ivu-radio-group-button .ivu-radio-wrapper{
    padding: 0;
}
#zbmodel .write_time .ivu-input-wrapper,#zbmodel .write_time input{
    border-radius: 0px !important;
    width: 224px;
    height: 54px;
    line-height: 54px;
}
#zbmodel .form_times .ivu-input-group{
    width: 220px;
    border-radius: 0px;
    border: none;
    color:#828282;
}
#zbmodel .form_times input , #zbmodel .form_times .ivu-input-group-append{
    border-radius: 0px;
    border: none;
    background:#f5f5f5;
    outline:none;
...
#zbmodel .ivu-radio-group-button.ivu-radio-group-large .ivu-radio-wrapper,#zbmodel textarea.ivu-input{
    font-size: 12px;
}
/* .title{
    font-size:20px;height:90px;line-height:90px;padding-left:40px;border-bottom:1px solid #f5f5f5;
} */
#zbmodel .ivu-steps,#zbmodel .ivu-steps .ivu-steps-head,#zbmodel .ivu-steps-item.ivu-steps-status-wait .ivu-steps-head-inner{
    background:#f5f5f5;
}
/* .pop-content{
    width:164px;
...
#zbmodel .ivu-poptip-body{
    padding:20px;
}
#zbmodel .ivu-poptip-arrow{
    display:none;
}
</style>
