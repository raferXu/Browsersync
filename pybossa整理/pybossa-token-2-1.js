...
(function(pybossa, $, undefined) {
    ...
    function _userProgress(projectname) {
        return $.ajax({
            ...
            success: function (data) {
                console.log('_userProgress函数的/userprogress接口返回的success数据: '+data);
                console.log(data);
            },
            error: function (date) {
              console.log('_userProgress函数的/userprogress接口返回的error数据: '+data);
              console.log(data);
            },
            cache: false,
            dataType: 'json'
    ...
    function _fetchProject(projectname) {
        return $.ajax({
            ...
            success: function (data) {
                console.log('_fetchProject函数的token/project接口返回的success数据: '+data);
                console.log(data);
            },
            error: function (data) {
                console.log('_fetchProject函数的token/project接口返回的error数据: '+data);
                console.log(data);
            },
    ...
    function _fetchNewTask(projectId, offset) {
        ...
        return $.ajax({
            ...
            success: function (data) {
                console.log('_fetchNewTask函数的token/project/id/newtask接口返回的success数据: '+data);
                console.log(data);
                console.log(data['id']);
                if(!data['id']){
            ...
            error: function (data) {
                console.log('_fetchNewTask函数的token/project/id/newtask接口返回的error数据: '+data);
                console.log(data);
            },
            data: 'offset=' + offset,
            cache: false,
    ...
    function _fetchTask(taskId) {
        return $.ajax({
            ...
            success: function (data) {
                console.log('_fetchTask函数的token/task/id接口返回的success数据: '+data);
                console.log(data);
            },
            error: function(data){
                console.log('_fetchTask函数的token/task/id接口返回的error数据: '+data);
                console.log(data);
                if(data.status == 401){
                    console.log('调用native的notifyToReligon方法弹出异地登陆框');
    ...
    function _saveTaskRun(taskrun) {
        return $.ajax({
            ...
            success: function (data) {
                console.log('_saveTaskRun函数的token/taskrun接口返回的success数据: '+data);
                console.log(data);
            },
            error: function (data) {
                console.log('_saveTaskRun函数的token/taskrun接口返回的error数据: '+data);
                console.log(data);
            },
            dataType: 'json',
