    ...
    return $.ajax({
      ...
      success: function (data) {
        ...
        if(!data['id']){
          ...
          // 混合版没有project跳转，直接跳无任务
          location.href = '/static/h5/noTask.html';
        }
    ...
    _fetchProject(projectname).done(function(project) {
      ...
      function getNextTask(offset, previousTask) {
        ...
        xhr.done(function(task) {
          ...
          switch (taskType){
            case 'sn':
              inputHtml = '<div class="showInfo" style="height:.44rem !important;;border:none;">'+
            ...
            case 'total':
              ...
              break;
            case 'date':
              inputHtml = '<div style="height:.84rem;border:none;" class="showInfo">'+
